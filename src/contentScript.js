...
const createChatGPTIcon = parentElement => {
...
const createAnswerElement = () => {
  ...
  answerElement.id = "chatGPTAnswer";
  ...
  textElement.id = "chatGPTAnswerText";
...
const incrementAnswerCount = () => {
  ...
  plusOne.style.color = "rgb(16, 163, 127)";
